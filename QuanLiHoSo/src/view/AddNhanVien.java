...
public class AddNhanVien extends javax.swing.JDialog {
    ...
    public AddNhanVien(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) {
        super(owner, modal);
    ...
    private AddNhanVien(JFrame jFrame, boolean b) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    ...
    private void initComponents() {
        ...
        txtMaNhanVien.setFont(new java.awt.Font("SF Pro Display", 0, 16)); // NOI18N
        jPanel1.add(txtMaNhanVien, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 130, 298, 38));
        ...
        txtTenNhanVien.setFont(new java.awt.Font("SF Pro Display", 0, 16)); // NOI18N
        jPanel1.add(txtTenNhanVien, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 210, 298, 38));
        ...
        txtCongViec.setFont(new java.awt.Font("SF Pro Display", 0, 16)); // NOI18N
        jPanel1.add(txtCongViec, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 370, 298, 38));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String sdtNV = txtphone1.getText().trim();
            String congviecNV = txtCongViec.getText().trim();
            if (maNV.equals("") || tenNV.equals("") || sdtNV.equals("") || congviecNV.equals("")) {
                JOptionPane.showMessageDialog(this, "Vui lòng nhập đầy đủ thông tin !", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
            } else {
                if (NhanVienDAO.getInstance().selectById(maNV) != null) {
                    NhanVien nv = new NhanVien();
                    nv.setMaNhanVien(maNV);
                    nv.setTenNhanVien(tenNV);
                    nv.setSdt(sdtNV);
                    nv.setCongViec(congviecNV);
