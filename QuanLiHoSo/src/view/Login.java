...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        loginUser.setBackground(new java.awt.Color(0, 102, 51));
        ...
        passwordUser.setBackground(new java.awt.Color(0, 102, 51));
...
//                                    ad.setCurrentAcc(acc);
                                    ...
                                    NhanVien_vaitro nv = new NhanVien_vaitro();
                                    nv.setVisible(true);
                                    nv.setCurrentAcc(acc);
